local Translations = {
    ...
    you_are_discount_eligible                = "If you go on duty, you could recieve a discount of " ..
        Config.EmergencyServicesDiscount['discount'] .. "%!",
    no_fuel                                  = "No fuel..",
    ...
    station_name_too_long                    = "Name cannot be longer than " ..
        Config.NameChangeMaxChar .. " characters.",
    ...
    station_reserves_over_max                = "You cannot purchase this amount as it will be great than the maximum amount of " ..
        Config.MaxFuelReserves .. " Liters",
